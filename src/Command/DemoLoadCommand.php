...
HTML, true, [
        ...
        $docs[] = $this->fileDoc($orders, $kuznetsova, 'Приказ о графике отпусков на 2026 год', 'ПР-2026-01', null, ['отпуска', '2026'], $today->modify('+3 months'), $this->pdf($tmp, 'PR-2026-01', 'Prikaz o grafike otpuskov 2026'), true);
